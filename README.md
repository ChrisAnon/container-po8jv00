...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-po8jv00.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-po8jv00.containers.anotherwebservice.com/
...
```
git clone git@github.com:ChrisAnon/container-po8jv00.git
cd container-po8jv00
```
...
```
docker attach container-po8jv00
```
